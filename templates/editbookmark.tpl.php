...
<table>
<tr>
    <th align="left"><?php echo T_('Aadress'); ?></th>
...
<tr>
    <th align="left"><?php echo T_('Tiitel'); ?></th>
...
<tr>
    <th align="left"><?php echo T_('Võtmesõnad'); ?></th>
...
<tr>
    ...
    <td>
        ...
        <?php if ($showdelete): ?>
          <input type="submit" name="delete" value="<?php echo T_('Kustuta järjehoidja'); ?>" />
        <?php endif; ?>
        <?php if ($popup): ?>
