...
* Use the SQL contained in tables.sql to create the necessary database tables.
 This file was written specifically for MySQL, so may need rewritten if you intend to use a different database system.
